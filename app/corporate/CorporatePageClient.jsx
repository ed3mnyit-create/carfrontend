...
export default function CorporatePageClient() {
  ...
  const steps = [
    t("corporate.steps.step1"),
    t("corporate.steps.step2"),
    t("corporate.steps.step3"),
  ];
        ...
        <Container maxWidth="xl" className="relative z-10">
          <div className="flex min-h-[72vh] max-w-4xl flex-col justify-center py-24">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              >
                {t("corporate.cta.primary")}
                <Send sx={{ fontSize: 18 }} />
              </a>
              <a
                href="#corporate-services"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/[0.08] px-6 py-3 text-sm font-black text-white backdrop-blur-md transition hover:border-primary/35"
              >
                {t("corporate.cta.secondary")}
      ...
      <Container maxWidth="xl" className="relative z-10">
        ...
        <section className="mb-16 overflow-hidden rounded-[2rem] border border-primary/25 bg-primary/10 p-6 md:rounded-[3rem] md:p-10">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              <p className="mb-3 text-xs font-black uppercase tracking-[0.22em] text-primary">
                {t("corporate.midCta.eyebrow")}
              </p>
              <h2 className="text-3xl font-black leading-tight text-white md:text-5xl">
                {t("corporate.midCta.title")}
              </h2>
              <p className="mt-4 text-sm font-bold leading-7 text-slate-400">
                {t("corporate.midCta.text")}
              </p>
            </div>
            <a
              href="#corporate-offer"
        ...
        <section className="mb-16 rounded-[2rem] border border-primary/20 bg-primary/10 p-5 md:rounded-[3rem] md:p-8">
          <div className="mb-6 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="mb-3 text-xs font-black uppercase tracking-[0.22em] text-primary">
                {t("corporate.steps.eyebrow")}
              </p>
              <h2 className="text-3xl font-black leading-tight text-white">
                {t("corporate.steps.title")}
              </h2>
            </div>
        ...
        <section className="mb-16">
          <div className="mb-8 max-w-3xl text-start">
            <p className="mb-3 text-xs font-black uppercase tracking-[0.22em] text-primary">
              {t("corporate.faq.eyebrow")}
            </p>
            <h2 className="text-3xl font-black leading-tight text-white md:text-5xl">
              {t("corporate.faq.title")}
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <label className="block text-start md:col-span-2">
              ...
              <textarea
                ...
                placeholder={t("corporate.form.placeholder")}
              />
            </label>
